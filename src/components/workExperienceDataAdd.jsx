...
const WorkExperienceDataAdd=({experienceSelected, handleChange, add, show, setShow})=> {
                ...
                <form>
                        ...
                        <ul className="list-inline d-flex mb-0">
                            ...
                            <li className="list-inline-item ml-auto my-auto">
                                <Form.Check
                                    ...
                                    name="iamExperience"
                                    type="checkbox"
                                    value={experienceSelected?experienceSelected.iamExperience:''}
                                    onChange={(e)=>handleChange(e)}
                        ...
                        <ul className="list-inline d-flex mb-0">
                            ...
                            <li className="list-inline-item ml-auto my-auto">
                                <Form.Check
                                    ...
                                    name="remote"
                                    type="checkbox"
                                    value={experienceSelected?experienceSelected.remote:''}
                                    onChange={(e)=>handleChange(e)}
                                    label={`Remote work`}
                                />
                            </li>
                    ...
                    <div className="sticky-bottom border-top">
                        <ul className="list-inline mt-4 mb-2 float-right">
                            ...
                            <li className="list-inline-item">
                                <Button variant="primary px-4" onClick={()=>add()}>
                                    Save
                                </Button>
                            </li>
                        </ul>
...
export default WorkExperienceDataAdd;